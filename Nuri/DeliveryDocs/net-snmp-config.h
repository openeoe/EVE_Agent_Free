...
#define CONFIGURE_OPTIONS "--with-libs=-lperfstat -lpthread -llvm -lcfg -lodm -lpcap -lNASC_FTP --disable-shared --with-mib-modules=host mibII Nuri/psMonitorTable Nuri/logMonRowTable Nuri/trapTable Nuri/monitorPolicyTable Nuri/collectDataTable Nuri/agentInfo nuri/subAgentConfig Nuri/logMonColumnTable Nuri/netApplicationMonitoringTable Nuri/transactionTable NuriEnterprise/System NuriEnterprise/sysStatisticsTable NuriEnterprise/fsTable NuriEnterprise/diskTable NuriEnterprise/cpuTable NuriEnterprise/Process NuriEnterprise/MessageQueue NuriEnterprise/SharedMemory NuriEnterprise/Semaphore NuriEnterprise/networkTable --with-out-mib-modules=ucd_snmp snmpv3mibs notification target agent_mibs agentx agent_mibs utilities"
