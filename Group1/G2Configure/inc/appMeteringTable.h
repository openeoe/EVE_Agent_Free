 ...
 *
 * $Id: appMeteringTable.h,v 1.1 2003/12/01 14:29:00 guga Exp $
 *
...
/** #define values**/
#define APP_MAX_OID_LEN 128
#define APP_MAX_VAR_LEN 255
#define APP_NO_OF_FIELDS 16
#define APP_NO_OF_TRAP_FIELDS 5
#define APP_CONTAINER_FILE "appMeteringTable.conf"
#define APP_SUCCESS 1
#define APP_FAILURE 2
#define APP_TRAP 1
#define APP_ROW_CREATE 4
#define APP_ROW_DELETE 6
#define APP_MAX_DT_LEN 20
...
typedef struct appMeteringTable_context_s {
     ...
     */
        ...
        /** DateAndTime = ASN_OCTET_STR */
            unsigned char appMeteringCreatedDateTime[20];
        ...
        /** DateAndTime = ASN_OCTET_STR */
            unsigned char appMeteringStartTime[20];
            long appMeteringStartTime_len;

        /** DateAndTime = ASN_OCTET_STR */
            unsigned char appMeteringEndTime[20];
        ...
        /** DateAndTime = ASN_OCTET_STR */
            unsigned char appMeteringLastUpdatedDateAndTime[20];
