 ...
 *
 * $Id: allowSMTPTable.h,v 1.1 2003/12/01 14:27:15 guga Exp $
 *
...
#define SMTP_CONTAINER_FILE "allowSMTPTable.conf"
...
typedef struct allowSMTPTable_context_s {
     ...
     */
        ...
        /** IPADDR = ASN_IPADDRESS */
            unsigned long allowSMTPIPAddress;
...
int allowSMTPTable_send_snmptrap(int length,stVarBindArgs *trapPDU,int port);
static int
