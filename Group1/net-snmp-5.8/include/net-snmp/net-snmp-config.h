...
#define NETSNMP_CONFIGURE_OPTIONS " '--prefix=c:/usr' '--with-mib-modules=agentx disman/event-mib winExtDLL examples/example mibII host nuri/cpuTable' '--with-enterprise-oid=46971' '--with-enterprise-sysoid=.1.3.6.1.4.1.46971.3.2' '--with-mibdirs=c:/usr/share/snmp/mibs' '--disable-embedded-perl' '--without-perl-modules'"
...
#define NETSNMP_DEFAULT_MIBDIRS "c:/usr/share/snmp/mibs"
...
#define NETSNMP_DEFAULT_MIBS ";SNMPv2-MIB;IF-MIB;IP-MIB;TCP-MIB;UDP-MIB;HOST-RESOURCES-MIB;NOTIFICATION-LOG-MIB;DISMAN-EVENT-MIB;DISMAN-SCHEDULE-MIB;HOST-RESOURCES-TYPES;UCD-SNMP-MIB;UCD-DEMO-MIB;SNMP-TARGET-MIB;NET-SNMP-AGENT-MIB;SNMP-VIEW-BASED-ACM-MIB;SNMP-COMMUNITY-MIB;SNMP-FRAMEWORK-MIB;SNMP-MPD-MIB;SNMP-USER-BASED-SM-MIB;NET-SNMP-PASS-MIB;NET-SNMP-EXTEND-MIB;UCD-DLMOD-MIB;SNMP-NOTIFICATION-MIB;SNMPv2-TM;NET-SNMP-VACM-MIB"
...
#define SNMPLIBPATH "c:/usr/lib/snmp"
#define SNMPSHAREPATH "c:/usr/share/snmp"
#define SNMPCONFPATH "c:/usr/etc/snmp"
#define SNMPDLMODPATH "c:/usr/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "/usr/adm/snmpd.log"
...
#define NETSNMP_ENTERPRISE_OID 46971
#define NETSNMP_ENTERPRISE_MIB 1,3,6,1,4,1,46971
#define NETSNMP_ENTERPRISE_DOT_MIB 1.3.6.1.4.1.46971
#define NETSNMP_ENTERPRISE_DOT_MIB_LENGTH	7

/* The assigned enterprise number for sysObjectID. */
#define NETSNMP_SYSTEM_MIB 1,3,6,1,4,1,46971,3,2
#define NETSNMP_SYSTEM_DOT_MIB 1.3.6.1.4.1.46971.3.2
