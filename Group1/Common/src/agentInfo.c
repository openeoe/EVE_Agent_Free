/*$Id: agentInfo.c,v 1.7 2004/01/13 11:01:43 baravind Exp $*/
/*
...
#define MIN_FILE_TRANSFER_INTERVAL 10 // in seconds
...
/* Added by Sai on 10.12.2003 */
/* This value will be updated from MIB Latter */
long glAgentInfoLogFileLimitSize  = 1000 ; /* Size should be in Bytes*/
...
init_agentInfo(void)
{
    ...
    static oid agentInfoLogFileSize_oid[] = { 1,3,6,1,4,1,3204,1,3,36,1,29, 0 };

  DEBUGMSGTL(("agentInfo", "Initializing\n"));
  
  netsnmp_register_instance(netsnmp_create_handler_registration
                              ("agentInfoLogFileSize",
                               do_agentInfoLogFileSize,
                               agentInfoLogFileSize_oid,
                               OID_LENGTH(agentInfoLogFileSize_oid),
                               HANDLER_CAN_RWRITE));
                          ...
                          netsnmp_request_info *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_SET_COMMIT:
            /* XXX: delete temporary storage */
            if (requests->requestvb->type!= ASN_INTEGER  ||
			*(requests->requestvb->val.integer)<MIN_FILE_TRANSFER_INTERVAL) {
                /* try _really_really_ hard to never get to this point */
                netsnmp_set_request_error(reqinfo, requests, SNMP_ERR_COMMITFAILED);
            } else {
...
int
do_agentInfoLogFileSize(netsnmp_mib_handler *handler,
                          netsnmp_handler_registration *reginfo,
                          netsnmp_agent_request_info *reqinfo,
                          netsnmp_request_info *requests)
{
    ...
    switch(reqinfo->mode) {
        ...
        case MODE_GET:
            ...
            snmp_set_var_typed_value(requests->requestvb, ASN_INTEGER, 
							(u_char *) &glAgentInfoLogFileLimitSize, 
							sizeof(glAgentInfoLogFileLimitSize));
            break;
