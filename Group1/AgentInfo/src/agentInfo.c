/*$Id: agentInfo.c,v 1.4 2003/12/10 13:34:54 saisk Exp $*/
/*
...
#define EMPTY_STR "x"
#define STR_LEN 255
#define FILE_TRANSFER_INTERVAL 3000 // in seconds
#define FILE_TRANSFER_PORT 2000 // default port
/* "glAgentInfoLogFileLimitSize" Added by Sai on 10.12.2003 and currently set 
    to 1000 bytes, latter it will updated from MIB */
