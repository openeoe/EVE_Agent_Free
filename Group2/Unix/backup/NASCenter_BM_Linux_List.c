 ...
 *
 * $Author: thiagav $
 * $Log: NASCenter_BM_Linux_List.c,v $
 * Revision 1.1  2003/12/02 11:19:43  thiagav
 * Added
 *
 ...
 *
 * $Id: NASCenter_BM_Linux_List.c,v 1.1 2003/12/02 11:19:43 thiagav Exp $
 *
 ****************************************************************************/
 ...
 * calls            :   
*****************************************************************************/
void BM_AddNodeInBackupList( UI32  taskID, I16 iIndex, stList stListPtr) {
 ...
 * calls            :   - 
*****************************************************************************/
I16  BM_DeleteNodeFromList(stList stListPtr, I16 iIndex ,UI32 taskID )
{
       stList stDelStruct;
       stList stPrevPtr;
       stList tempPtr;
 ...
 * calls            :   - 
*****************************************************************************/
UI32  BM_GetTaskID(I16 iIndex , stList stListPtr)
{
       UI32 uiTaskID =0;
